...
public:
	...
	vector<CGeneralObject*> GlobalObjectTable;
	...
	virtual bool Function(CModule* Owner,CFunction* &Func,string Name);
	virtual bool UserType(CModule* Owner,CFunction* &Func,string Name);
	...
	virtual bool Definition(CModule* Owner,CFunction* &Func,string Name);
	virtual bool DefinitionOverFunc(CModule* Owner,CFunction* &Func,string Name);
	virtual bool UserTypeDefinition(CModule* Owner,CFunction* &Func, string Name);
...
protected:
	...
	bool CheckID(string ID,CModule* Owner,bool CheckOverFunc);
};
